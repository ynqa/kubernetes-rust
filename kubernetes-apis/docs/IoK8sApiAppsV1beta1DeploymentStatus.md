...
**conditions** | [**Vec<::models::IoK8sApiAppsV1beta1DeploymentCondition>**](io.k8s.api.apps.v1beta1.DeploymentCondition.md) | Represents the latest available observations of a deployment's current state. | [optional] 
