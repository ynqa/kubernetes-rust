...
------------ | ------------- | ------------- | -------------
**active_deadline_seconds** | **i64** | Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to terminate it; value must be positive integer | [optional] 
**backoff_limit** | **i32** | Specifies the number of retries before marking this job failed. Defaults to 6 | [optional] 
