...
pub struct IoK8sApiCoreV1PodCondition {
...
impl IoK8sApiCoreV1PodCondition {
  /// PodCondition contains details for the current condition of this pod.
  pub fn new(status: String, _type: String) -> IoK8sApiCoreV1PodCondition {
  ...
  pub fn with_last_probe_time(mut self, last_probe_time: String) -> IoK8sApiCoreV1PodCondition {
    self.last_probe_time = Some(last_probe_time);
    self
  }
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: String) -> IoK8sApiCoreV1PodCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> IoK8sApiCoreV1PodCondition {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_reason(mut self, reason: String) -> IoK8sApiCoreV1PodCondition {
    self.reason = Some(reason);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> IoK8sApiCoreV1PodCondition {
    self.status = status;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> IoK8sApiCoreV1PodCondition {
    self._type = _type;
    self
  }
