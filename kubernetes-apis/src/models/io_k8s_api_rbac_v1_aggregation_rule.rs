...
pub struct IoK8sApiRbacV1AggregationRule {
...
impl IoK8sApiRbacV1AggregationRule {
  /// AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole
  pub fn new() -> IoK8sApiRbacV1AggregationRule {
  ...
  pub fn with_cluster_role_selectors(mut self, cluster_role_selectors: Vec<::models::IoK8sApimachineryPkgApisMetaV1LabelSelector>) -> IoK8sApiRbacV1AggregationRule {
    self.cluster_role_selectors = Some(cluster_role_selectors);
    self
  }
