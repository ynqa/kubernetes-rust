...
pub struct IoK8sApiAutoscalingV2beta1ObjectMetricSource {
...
impl IoK8sApiAutoscalingV2beta1ObjectMetricSource {
  /// ObjectMetricSource indicates how to scale on a metric describing a kubernetes object (for example, hits-per-second on an Ingress object).
  pub fn new(metric_name: String, target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference, target_value: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
  ...
  pub fn with_average_value(mut self, average_value: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
    self.average_value = Some(average_value);
    self
  }
  ...
  pub fn with_metric_name(mut self, metric_name: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
    self.metric_name = metric_name;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_target(mut self, target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
    self.target = target;
    self
  }
  ...
  pub fn with_target_value(mut self, target_value: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricSource {
    self.target_value = target_value;
    self
  }
