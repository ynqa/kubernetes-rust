...
pub struct IoK8sApiAuthorizationV1NonResourceRule {
...
impl IoK8sApiAuthorizationV1NonResourceRule {
  /// NonResourceRule holds information that describes a rule for the non-resource
  pub fn new(verbs: Vec<String>) -> IoK8sApiAuthorizationV1NonResourceRule {
  ...
  pub fn with_non_resource_ur_ls(mut self, non_resource_ur_ls: Vec<String>) -> IoK8sApiAuthorizationV1NonResourceRule {
    self.non_resource_ur_ls = Some(non_resource_ur_ls);
    self
  }
  ...
  pub fn with_verbs(mut self, verbs: Vec<String>) -> IoK8sApiAuthorizationV1NonResourceRule {
    self.verbs = verbs;
    self
  }
