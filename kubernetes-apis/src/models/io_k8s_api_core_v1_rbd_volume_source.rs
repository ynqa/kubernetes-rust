...
impl IoK8sApiCoreV1RbdVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sApiCoreV1RbdVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_image(mut self, image: String) -> IoK8sApiCoreV1RbdVolumeSource {
    self.image = image;
    self
  }
  ...
  pub fn with_keyring(mut self, keyring: String) -> IoK8sApiCoreV1RbdVolumeSource {
    self.keyring = Some(keyring);
    self
  }
  ...
  pub fn with_monitors(mut self, monitors: Vec<String>) -> IoK8sApiCoreV1RbdVolumeSource {
    self.monitors = monitors;
    self
  }
  ...
  pub fn with_pool(mut self, pool: String) -> IoK8sApiCoreV1RbdVolumeSource {
    self.pool = Some(pool);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sApiCoreV1RbdVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sApiCoreV1LocalObjectReference) -> IoK8sApiCoreV1RbdVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> IoK8sApiCoreV1RbdVolumeSource {
    self.user = Some(user);
    self
  }
