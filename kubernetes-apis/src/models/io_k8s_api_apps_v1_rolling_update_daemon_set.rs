...
pub struct IoK8sApiAppsV1RollingUpdateDaemonSet {
  /// IntOrString is a type that can hold an int32 or a string.  When used in JSON or YAML marshalling and unmarshalling, it produces or consumes the inner type.  This allows you to have, for example, a JSON field that can accept a name or number.
  #[serde(rename = "maxUnavailable")]
  max_unavailable: Option<String>
}

impl IoK8sApiAppsV1RollingUpdateDaemonSet {
  /// Spec to control the desired behavior of daemon set rolling update.
  pub fn new() -> IoK8sApiAppsV1RollingUpdateDaemonSet {
  ...
  pub fn with_max_unavailable(mut self, max_unavailable: String) -> IoK8sApiAppsV1RollingUpdateDaemonSet {
    self.max_unavailable = Some(max_unavailable);
    self
  }
