...
/// IoK8sApiStorageV1StorageClass : StorageClass describes the parameters for a class of storage for which PersistentVolumes can be dynamically provisioned.  StorageClasses are non-namespaced; the name of the storage class according to etcd is in ObjectMeta.Name.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiStorageV1StorageClass {
...
impl IoK8sApiStorageV1StorageClass {
  /// StorageClass describes the parameters for a class of storage for which PersistentVolumes can be dynamically provisioned.  StorageClasses are non-namespaced; the name of the storage class according to etcd is in ObjectMeta.Name.
  pub fn new(provisioner: String) -> IoK8sApiStorageV1StorageClass {
  ...
  pub fn with_allow_volume_expansion(mut self, allow_volume_expansion: bool) -> IoK8sApiStorageV1StorageClass {
    self.allow_volume_expansion = Some(allow_volume_expansion);
    self
  }
  ...
  pub fn with_allowed_topologies(mut self, allowed_topologies: Vec<::models::IoK8sApiCoreV1TopologySelectorTerm>) -> IoK8sApiStorageV1StorageClass {
    self.allowed_topologies = Some(allowed_topologies);
    self
  }
  ...
  pub fn with_api_version(mut self, api_version: String) -> IoK8sApiStorageV1StorageClass {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> IoK8sApiStorageV1StorageClass {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::IoK8sApimachineryPkgApisMetaV1ObjectMeta) -> IoK8sApiStorageV1StorageClass {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_mount_options(mut self, mount_options: Vec<String>) -> IoK8sApiStorageV1StorageClass {
    self.mount_options = Some(mount_options);
    self
  }
  ...
  pub fn with_parameters(mut self, parameters: ::std::collections::HashMap<String, String>) -> IoK8sApiStorageV1StorageClass {
    self.parameters = Some(parameters);
    self
  }
  ...
  pub fn with_provisioner(mut self, provisioner: String) -> IoK8sApiStorageV1StorageClass {
    self.provisioner = provisioner;
    self
  }
  ...
  pub fn with_reclaim_policy(mut self, reclaim_policy: String) -> IoK8sApiStorageV1StorageClass {
    self.reclaim_policy = Some(reclaim_policy);
    self
  }
  ...
  pub fn with_volume_binding_mode(mut self, volume_binding_mode: String) -> IoK8sApiStorageV1StorageClass {
    self.volume_binding_mode = Some(volume_binding_mode);
    self
  }
