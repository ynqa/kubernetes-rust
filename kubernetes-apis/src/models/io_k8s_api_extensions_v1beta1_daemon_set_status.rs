...
/// IoK8sApiExtensionsV1beta1DaemonSetStatus : DaemonSetStatus represents the current status of a daemon set.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiExtensionsV1beta1DaemonSetStatus {
  /// Count of hash collisions for the DaemonSet. The DaemonSet controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ControllerRevision.
  #[serde(rename = "collisionCount")]
  collision_count: Option<i32>,
  /// Represents the latest available observations of a DaemonSet's current state.
  #[serde(rename = "conditions")]
  conditions: Option<Vec<::models::IoK8sApiExtensionsV1beta1DaemonSetCondition>>,
...
impl IoK8sApiExtensionsV1beta1DaemonSetStatus {
  /// DaemonSetStatus represents the current status of a daemon set.
  pub fn new(current_number_scheduled: i32, desired_number_scheduled: i32, number_misscheduled: i32, number_ready: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
  ...
  pub fn with_collision_count(mut self, collision_count: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::IoK8sApiExtensionsV1beta1DaemonSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::IoK8sApiExtensionsV1beta1DaemonSetCondition>) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::IoK8sApiExtensionsV1beta1DaemonSetCondition>> {
  ...
  pub fn with_current_number_scheduled(mut self, current_number_scheduled: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.current_number_scheduled = current_number_scheduled;
    self
  }
  ...
  pub fn with_desired_number_scheduled(mut self, desired_number_scheduled: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.desired_number_scheduled = desired_number_scheduled;
    self
  }
  ...
  pub fn with_number_available(mut self, number_available: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.number_available = Some(number_available);
    self
  }
  ...
  pub fn with_number_misscheduled(mut self, number_misscheduled: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.number_misscheduled = number_misscheduled;
    self
  }
  ...
  pub fn with_number_ready(mut self, number_ready: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.number_ready = number_ready;
    self
  }
  ...
  pub fn with_number_unavailable(mut self, number_unavailable: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.number_unavailable = Some(number_unavailable);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_updated_number_scheduled(mut self, updated_number_scheduled: i32) -> IoK8sApiExtensionsV1beta1DaemonSetStatus {
    self.updated_number_scheduled = Some(updated_number_scheduled);
    self
  }
