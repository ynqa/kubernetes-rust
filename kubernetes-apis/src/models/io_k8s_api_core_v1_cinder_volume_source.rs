...
impl IoK8sApiCoreV1CinderVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sApiCoreV1CinderVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sApiCoreV1CinderVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sApiCoreV1LocalObjectReference) -> IoK8sApiCoreV1CinderVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_volume_id(mut self, volume_id: String) -> IoK8sApiCoreV1CinderVolumeSource {
    self.volume_id = volume_id;
    self
  }
