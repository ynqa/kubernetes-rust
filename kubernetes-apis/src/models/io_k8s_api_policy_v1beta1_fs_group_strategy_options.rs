...
pub struct IoK8sApiPolicyV1beta1FsGroupStrategyOptions {
...
impl IoK8sApiPolicyV1beta1FsGroupStrategyOptions {
  /// FSGroupStrategyOptions defines the strategy type and options used to create the strategy.
  pub fn new() -> IoK8sApiPolicyV1beta1FsGroupStrategyOptions {
  ...
  pub fn with_ranges(mut self, ranges: Vec<::models::IoK8sApiPolicyV1beta1IdRange>) -> IoK8sApiPolicyV1beta1FsGroupStrategyOptions {
    self.ranges = Some(ranges);
    self
  }
  ...
  pub fn with_rule(mut self, rule: String) -> IoK8sApiPolicyV1beta1FsGroupStrategyOptions {
    self.rule = Some(rule);
    self
  }
