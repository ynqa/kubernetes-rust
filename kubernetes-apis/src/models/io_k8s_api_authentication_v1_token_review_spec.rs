...
pub struct IoK8sApiAuthenticationV1TokenReviewSpec {
...
impl IoK8sApiAuthenticationV1TokenReviewSpec {
  /// TokenReviewSpec is a description of the token authentication request.
  pub fn new() -> IoK8sApiAuthenticationV1TokenReviewSpec {
  ...
  pub fn with_audiences(mut self, audiences: Vec<String>) -> IoK8sApiAuthenticationV1TokenReviewSpec {
    self.audiences = Some(audiences);
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> IoK8sApiAuthenticationV1TokenReviewSpec {
    self.token = Some(token);
    self
  }
