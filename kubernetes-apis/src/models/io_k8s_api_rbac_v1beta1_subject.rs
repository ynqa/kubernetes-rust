...
pub struct IoK8sApiRbacV1beta1Subject {
...
impl IoK8sApiRbacV1beta1Subject {
  /// Subject contains a reference to the object or user identities a role binding applies to.  This can either hold a direct API object reference, or a value for non-objects such as user and group names.
  pub fn new(kind: String, name: String) -> IoK8sApiRbacV1beta1Subject {
  ...
  pub fn with_api_group(mut self, api_group: String) -> IoK8sApiRbacV1beta1Subject {
    self.api_group = Some(api_group);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> IoK8sApiRbacV1beta1Subject {
    self.kind = kind;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> IoK8sApiRbacV1beta1Subject {
    self.name = name;
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> IoK8sApiRbacV1beta1Subject {
    self.namespace = Some(namespace);
    self
  }
