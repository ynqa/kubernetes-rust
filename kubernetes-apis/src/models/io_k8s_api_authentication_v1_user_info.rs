...
pub struct IoK8sApiAuthenticationV1UserInfo {
...
impl IoK8sApiAuthenticationV1UserInfo {
  /// UserInfo holds the information about the user needed to implement the user.Info interface.
  pub fn new() -> IoK8sApiAuthenticationV1UserInfo {
  ...
  pub fn with_extra(mut self, extra: ::std::collections::HashMap<String, Vec<String>>) -> IoK8sApiAuthenticationV1UserInfo {
    self.extra = Some(extra);
    self
  }
  ...
  pub fn with_groups(mut self, groups: Vec<String>) -> IoK8sApiAuthenticationV1UserInfo {
    self.groups = Some(groups);
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> IoK8sApiAuthenticationV1UserInfo {
    self.uid = Some(uid);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> IoK8sApiAuthenticationV1UserInfo {
    self.username = Some(username);
    self
  }
