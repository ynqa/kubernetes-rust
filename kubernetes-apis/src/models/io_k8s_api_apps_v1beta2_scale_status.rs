...
/// IoK8sApiAppsV1beta2ScaleStatus : ScaleStatus represents the current status of a scale subresource.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiAppsV1beta2ScaleStatus {
...
impl IoK8sApiAppsV1beta2ScaleStatus {
  /// ScaleStatus represents the current status of a scale subresource.
  pub fn new(replicas: i32) -> IoK8sApiAppsV1beta2ScaleStatus {
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sApiAppsV1beta2ScaleStatus {
    self.replicas = replicas;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::std::collections::HashMap<String, String>) -> IoK8sApiAppsV1beta2ScaleStatus {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_target_selector(mut self, target_selector: String) -> IoK8sApiAppsV1beta2ScaleStatus {
    self.target_selector = Some(target_selector);
    self
  }
