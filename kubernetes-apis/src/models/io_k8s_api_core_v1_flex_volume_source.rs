...
impl IoK8sApiCoreV1FlexVolumeSource {
  ...
  pub fn with_driver(mut self, driver: String) -> IoK8sApiCoreV1FlexVolumeSource {
    self.driver = driver;
    self
  }
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sApiCoreV1FlexVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_options(mut self, options: ::std::collections::HashMap<String, String>) -> IoK8sApiCoreV1FlexVolumeSource {
    self.options = Some(options);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sApiCoreV1FlexVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sApiCoreV1LocalObjectReference) -> IoK8sApiCoreV1FlexVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
