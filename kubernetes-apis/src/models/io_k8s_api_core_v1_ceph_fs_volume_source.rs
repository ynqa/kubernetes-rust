...
impl IoK8sApiCoreV1CephFsVolumeSource {
  ...
  pub fn with_monitors(mut self, monitors: Vec<String>) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.monitors = monitors;
    self
  }
  ...
  pub fn with_path(mut self, path: String) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.path = Some(path);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_file(mut self, secret_file: String) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.secret_file = Some(secret_file);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sApiCoreV1LocalObjectReference) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> IoK8sApiCoreV1CephFsVolumeSource {
    self.user = Some(user);
    self
  }
