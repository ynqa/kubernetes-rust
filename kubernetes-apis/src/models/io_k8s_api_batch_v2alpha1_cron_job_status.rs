...
pub struct IoK8sApiBatchV2alpha1CronJobStatus {
...
impl IoK8sApiBatchV2alpha1CronJobStatus {
  /// CronJobStatus represents the current state of a cron job.
  pub fn new() -> IoK8sApiBatchV2alpha1CronJobStatus {
  ...
  pub fn with_active(mut self, active: Vec<::models::IoK8sApiCoreV1ObjectReference>) -> IoK8sApiBatchV2alpha1CronJobStatus {
    self.active = Some(active);
    self
  }
  ...
  pub fn with_last_schedule_time(mut self, last_schedule_time: String) -> IoK8sApiBatchV2alpha1CronJobStatus {
    self.last_schedule_time = Some(last_schedule_time);
    self
  }
