...
pub struct IoK8sApiAutoscalingV2beta1PodsMetricSource {
...
impl IoK8sApiAutoscalingV2beta1PodsMetricSource {
  /// PodsMetricSource indicates how to scale on a metric describing each pod in the current scale target (for example, transactions-processed-per-second). The values will be averaged together before being compared to the target value.
  pub fn new(metric_name: String, target_average_value: String) -> IoK8sApiAutoscalingV2beta1PodsMetricSource {
  ...
  pub fn with_metric_name(mut self, metric_name: String) -> IoK8sApiAutoscalingV2beta1PodsMetricSource {
    self.metric_name = metric_name;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAutoscalingV2beta1PodsMetricSource {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_target_average_value(mut self, target_average_value: String) -> IoK8sApiAutoscalingV2beta1PodsMetricSource {
    self.target_average_value = target_average_value;
    self
  }
