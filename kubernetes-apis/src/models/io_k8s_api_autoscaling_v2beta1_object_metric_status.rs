...
pub struct IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
  ...
  #[serde(rename = "target")]
  target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference
}

impl IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
  /// ObjectMetricStatus indicates the current value of a metric describing a kubernetes object (for example, hits-per-second on an Ingress object).
  pub fn new(current_value: String, metric_name: String, target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
  ...
  pub fn with_average_value(mut self, average_value: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
    self.average_value = Some(average_value);
    self
  }
  ...
  pub fn with_current_value(mut self, current_value: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
    self.current_value = current_value;
    self
  }
  ...
  pub fn with_metric_name(mut self, metric_name: String) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
    self.metric_name = metric_name;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn set_target(&mut self, target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference) {
    self.target = target;
  }

  pub fn with_target(mut self, target: ::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus {
    self.target = target;
    self
  }

  pub fn target(&self) -> &::models::IoK8sApiAutoscalingV2beta1CrossVersionObjectReference {
    &self.target
  }
