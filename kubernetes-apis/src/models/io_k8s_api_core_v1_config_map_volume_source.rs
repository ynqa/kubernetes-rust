...
impl IoK8sApiCoreV1ConfigMapVolumeSource {
  ...
  pub fn with_default_mode(mut self, default_mode: i32) -> IoK8sApiCoreV1ConfigMapVolumeSource {
    self.default_mode = Some(default_mode);
    self
  }
  ...
  pub fn with_items(mut self, items: Vec<::models::IoK8sApiCoreV1KeyToPath>) -> IoK8sApiCoreV1ConfigMapVolumeSource {
    self.items = Some(items);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> IoK8sApiCoreV1ConfigMapVolumeSource {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_optional(mut self, optional: bool) -> IoK8sApiCoreV1ConfigMapVolumeSource {
    self.optional = Some(optional);
    self
  }
