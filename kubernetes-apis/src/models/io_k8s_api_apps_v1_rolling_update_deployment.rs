...
pub struct IoK8sApiAppsV1RollingUpdateDeployment {
...
impl IoK8sApiAppsV1RollingUpdateDeployment {
  /// Spec to control the desired behavior of rolling update.
  pub fn new() -> IoK8sApiAppsV1RollingUpdateDeployment {
  ...
  pub fn with_max_surge(mut self, max_surge: String) -> IoK8sApiAppsV1RollingUpdateDeployment {
    self.max_surge = Some(max_surge);
    self
  }
  ...
  pub fn with_max_unavailable(mut self, max_unavailable: String) -> IoK8sApiAppsV1RollingUpdateDeployment {
    self.max_unavailable = Some(max_unavailable);
    self
  }
