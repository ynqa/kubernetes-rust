...
/// IoK8sApiExtensionsV1beta1PodSecurityPolicySpec : PodSecurityPolicySpec defines the policy enforced. Deprecated: use PodSecurityPolicySpec from policy API Group instead.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
  ...
  allowed_flex_volumes: Option<Vec<::models::IoK8sApiExtensionsV1beta1AllowedFlexVolume>>,
  /// allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.
  #[serde(rename = "allowedHostPaths")]
  allowed_host_paths: Option<Vec<::models::IoK8sApiExtensionsV1beta1AllowedHostPath>>,
  ...
  fs_group: ::models::IoK8sApiExtensionsV1beta1FsGroupStrategyOptions,
  ...
  host_ports: Option<Vec<::models::IoK8sApiExtensionsV1beta1HostPortRange>>,
  ...
  run_as_group: Option<::models::IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions>,
  #[serde(rename = "runAsUser")]
  run_as_user: ::models::IoK8sApiExtensionsV1beta1RunAsUserStrategyOptions,
  #[serde(rename = "seLinux")]
  se_linux: ::models::IoK8sApiExtensionsV1beta1SeLinuxStrategyOptions,
  #[serde(rename = "supplementalGroups")]
  supplemental_groups: ::models::IoK8sApiExtensionsV1beta1SupplementalGroupsStrategyOptions,
  /// volumes is a white list of allowed volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use '*'.
  #[serde(rename = "volumes")]
  volumes: Option<Vec<String>>
}

impl IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
  /// PodSecurityPolicySpec defines the policy enforced. Deprecated: use PodSecurityPolicySpec from policy API Group instead.
  pub fn new(fs_group: ::models::IoK8sApiExtensionsV1beta1FsGroupStrategyOptions, run_as_user: ::models::IoK8sApiExtensionsV1beta1RunAsUserStrategyOptions, se_linux: ::models::IoK8sApiExtensionsV1beta1SeLinuxStrategyOptions, supplemental_groups: ::models::IoK8sApiExtensionsV1beta1SupplementalGroupsStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
  ...
  pub fn with_allow_privilege_escalation(mut self, allow_privilege_escalation: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allow_privilege_escalation = Some(allow_privilege_escalation);
    self
  }
  ...
  pub fn with_allowed_capabilities(mut self, allowed_capabilities: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allowed_capabilities = Some(allowed_capabilities);
    self
  }
  ...
  pub fn set_allowed_flex_volumes(&mut self, allowed_flex_volumes: Vec<::models::IoK8sApiExtensionsV1beta1AllowedFlexVolume>) {
    self.allowed_flex_volumes = Some(allowed_flex_volumes);
  }

  pub fn with_allowed_flex_volumes(mut self, allowed_flex_volumes: Vec<::models::IoK8sApiExtensionsV1beta1AllowedFlexVolume>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allowed_flex_volumes = Some(allowed_flex_volumes);
    self
  }

  pub fn allowed_flex_volumes(&self) -> Option<&Vec<::models::IoK8sApiExtensionsV1beta1AllowedFlexVolume>> {
  ...
  pub fn set_allowed_host_paths(&mut self, allowed_host_paths: Vec<::models::IoK8sApiExtensionsV1beta1AllowedHostPath>) {
    self.allowed_host_paths = Some(allowed_host_paths);
  }

  pub fn with_allowed_host_paths(mut self, allowed_host_paths: Vec<::models::IoK8sApiExtensionsV1beta1AllowedHostPath>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allowed_host_paths = Some(allowed_host_paths);
    self
  }

  pub fn allowed_host_paths(&self) -> Option<&Vec<::models::IoK8sApiExtensionsV1beta1AllowedHostPath>> {
  ...
  pub fn with_allowed_proc_mount_types(mut self, allowed_proc_mount_types: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allowed_proc_mount_types = Some(allowed_proc_mount_types);
    self
  }
  ...
  pub fn with_allowed_unsafe_sysctls(mut self, allowed_unsafe_sysctls: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.allowed_unsafe_sysctls = Some(allowed_unsafe_sysctls);
    self
  }
  ...
  pub fn with_default_add_capabilities(mut self, default_add_capabilities: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.default_add_capabilities = Some(default_add_capabilities);
    self
  }
  ...
  pub fn with_default_allow_privilege_escalation(mut self, default_allow_privilege_escalation: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.default_allow_privilege_escalation = Some(default_allow_privilege_escalation);
    self
  }
  ...
  pub fn with_forbidden_sysctls(mut self, forbidden_sysctls: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.forbidden_sysctls = Some(forbidden_sysctls);
    self
  }
  ...
  pub fn set_fs_group(&mut self, fs_group: ::models::IoK8sApiExtensionsV1beta1FsGroupStrategyOptions) {
    self.fs_group = fs_group;
  }

  pub fn with_fs_group(mut self, fs_group: ::models::IoK8sApiExtensionsV1beta1FsGroupStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.fs_group = fs_group;
    self
  }

  pub fn fs_group(&self) -> &::models::IoK8sApiExtensionsV1beta1FsGroupStrategyOptions {
    &self.fs_group
  }
  ...
  pub fn with_host_ipc(mut self, host_ipc: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.host_ipc = Some(host_ipc);
    self
  }
  ...
  pub fn with_host_network(mut self, host_network: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.host_network = Some(host_network);
    self
  }
  ...
  pub fn with_host_pid(mut self, host_pid: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.host_pid = Some(host_pid);
    self
  }
  ...
  pub fn set_host_ports(&mut self, host_ports: Vec<::models::IoK8sApiExtensionsV1beta1HostPortRange>) {
    self.host_ports = Some(host_ports);
  }

  pub fn with_host_ports(mut self, host_ports: Vec<::models::IoK8sApiExtensionsV1beta1HostPortRange>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.host_ports = Some(host_ports);
    self
  }

  pub fn host_ports(&self) -> Option<&Vec<::models::IoK8sApiExtensionsV1beta1HostPortRange>> {
  ...
  pub fn with_privileged(mut self, privileged: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.privileged = Some(privileged);
    self
  }
  ...
  pub fn with_read_only_root_filesystem(mut self, read_only_root_filesystem: bool) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.read_only_root_filesystem = Some(read_only_root_filesystem);
    self
  }
  ...
  pub fn with_required_drop_capabilities(mut self, required_drop_capabilities: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.required_drop_capabilities = Some(required_drop_capabilities);
    self
  }
  ...
  pub fn set_run_as_group(&mut self, run_as_group: ::models::IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions) {
    self.run_as_group = Some(run_as_group);
  }

  pub fn with_run_as_group(mut self, run_as_group: ::models::IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.run_as_group = Some(run_as_group);
    self
  }

  pub fn run_as_group(&self) -> Option<&::models::IoK8sApiExtensionsV1beta1RunAsGroupStrategyOptions> {
  ...
  pub fn set_run_as_user(&mut self, run_as_user: ::models::IoK8sApiExtensionsV1beta1RunAsUserStrategyOptions) {
    self.run_as_user = run_as_user;
  }

  pub fn with_run_as_user(mut self, run_as_user: ::models::IoK8sApiExtensionsV1beta1RunAsUserStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.run_as_user = run_as_user;
    self
  }

  pub fn run_as_user(&self) -> &::models::IoK8sApiExtensionsV1beta1RunAsUserStrategyOptions {
    &self.run_as_user
  }


  pub fn set_se_linux(&mut self, se_linux: ::models::IoK8sApiExtensionsV1beta1SeLinuxStrategyOptions) {
    self.se_linux = se_linux;
  }

  pub fn with_se_linux(mut self, se_linux: ::models::IoK8sApiExtensionsV1beta1SeLinuxStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.se_linux = se_linux;
    self
  }

  pub fn se_linux(&self) -> &::models::IoK8sApiExtensionsV1beta1SeLinuxStrategyOptions {
    &self.se_linux
  }


  pub fn set_supplemental_groups(&mut self, supplemental_groups: ::models::IoK8sApiExtensionsV1beta1SupplementalGroupsStrategyOptions) {
    self.supplemental_groups = supplemental_groups;
  }

  pub fn with_supplemental_groups(mut self, supplemental_groups: ::models::IoK8sApiExtensionsV1beta1SupplementalGroupsStrategyOptions) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.supplemental_groups = supplemental_groups;
    self
  }

  pub fn supplemental_groups(&self) -> &::models::IoK8sApiExtensionsV1beta1SupplementalGroupsStrategyOptions {
  ...
  pub fn with_volumes(mut self, volumes: Vec<String>) -> IoK8sApiExtensionsV1beta1PodSecurityPolicySpec {
    self.volumes = Some(volumes);
    self
  }
