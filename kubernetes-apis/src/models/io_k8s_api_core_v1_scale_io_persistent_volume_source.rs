...
pub struct IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
  ...
  secret_ref: ::models::IoK8sApiCoreV1SecretReference,
...
impl IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
  /// ScaleIOPersistentVolumeSource represents a persistent ScaleIO volume
  pub fn new(gateway: String, secret_ref: ::models::IoK8sApiCoreV1SecretReference, system: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_gateway(mut self, gateway: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.gateway = gateway;
    self
  }
  ...
  pub fn with_protection_domain(mut self, protection_domain: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.protection_domain = Some(protection_domain);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::IoK8sApiCoreV1SecretReference) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.secret_ref = secret_ref;
    self
  }

  pub fn secret_ref(&self) -> &::models::IoK8sApiCoreV1SecretReference {
    &self.secret_ref
  }
  ...
  pub fn with_ssl_enabled(mut self, ssl_enabled: bool) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.ssl_enabled = Some(ssl_enabled);
    self
  }
  ...
  pub fn with_storage_mode(mut self, storage_mode: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.storage_mode = Some(storage_mode);
    self
  }
  ...
  pub fn with_storage_pool(mut self, storage_pool: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.storage_pool = Some(storage_pool);
    self
  }
  ...
  pub fn with_system(mut self, system: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.system = system;
    self
  }
  ...
  pub fn with_volume_name(mut self, volume_name: String) -> IoK8sApiCoreV1ScaleIoPersistentVolumeSource {
    self.volume_name = Some(volume_name);
    self
  }
