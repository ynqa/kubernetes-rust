...
pub struct IoK8sApiAppsV1StatefulSetSpec {
  ...
  update_strategy: Option<::models::IoK8sApiAppsV1StatefulSetUpdateStrategy>,
...
impl IoK8sApiAppsV1StatefulSetSpec {
  /// A StatefulSetSpec is the specification of a StatefulSet.
  pub fn new(selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector, service_name: String, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1StatefulSetSpec {
  ...
  pub fn with_pod_management_policy(mut self, pod_management_policy: String) -> IoK8sApiAppsV1StatefulSetSpec {
    self.pod_management_policy = Some(pod_management_policy);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sApiAppsV1StatefulSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> IoK8sApiAppsV1StatefulSetSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAppsV1StatefulSetSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn with_service_name(mut self, service_name: String) -> IoK8sApiAppsV1StatefulSetSpec {
    self.service_name = service_name;
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1StatefulSetSpec {
    self.template = template;
    self
  }
  ...
  pub fn set_update_strategy(&mut self, update_strategy: ::models::IoK8sApiAppsV1StatefulSetUpdateStrategy) {
    self.update_strategy = Some(update_strategy);
  }

  pub fn with_update_strategy(mut self, update_strategy: ::models::IoK8sApiAppsV1StatefulSetUpdateStrategy) -> IoK8sApiAppsV1StatefulSetSpec {
    self.update_strategy = Some(update_strategy);
    self
  }

  pub fn update_strategy(&self) -> Option<&::models::IoK8sApiAppsV1StatefulSetUpdateStrategy> {
  ...
  pub fn with_volume_claim_templates(mut self, volume_claim_templates: Vec<::models::IoK8sApiCoreV1PersistentVolumeClaim>) -> IoK8sApiAppsV1StatefulSetSpec {
    self.volume_claim_templates = Some(volume_claim_templates);
    self
  }
