...
pub struct IoK8sApiAutoscalingV2beta1ExternalMetricSource {
...
impl IoK8sApiAutoscalingV2beta1ExternalMetricSource {
  /// ExternalMetricSource indicates how to scale on a metric not associated with any Kubernetes object (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster). Exactly one \"target\" type should be set.
  pub fn new(metric_name: String) -> IoK8sApiAutoscalingV2beta1ExternalMetricSource {
  ...
  pub fn with_metric_name(mut self, metric_name: String) -> IoK8sApiAutoscalingV2beta1ExternalMetricSource {
    self.metric_name = metric_name;
    self
  }
  ...
  pub fn with_metric_selector(mut self, metric_selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAutoscalingV2beta1ExternalMetricSource {
    self.metric_selector = Some(metric_selector);
    self
  }
  ...
  pub fn with_target_average_value(mut self, target_average_value: String) -> IoK8sApiAutoscalingV2beta1ExternalMetricSource {
    self.target_average_value = Some(target_average_value);
    self
  }
  ...
  pub fn with_target_value(mut self, target_value: String) -> IoK8sApiAutoscalingV2beta1ExternalMetricSource {
    self.target_value = Some(target_value);
    self
  }
