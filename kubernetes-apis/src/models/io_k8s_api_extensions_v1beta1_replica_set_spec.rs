...
/// IoK8sApiExtensionsV1beta1ReplicaSetSpec : ReplicaSetSpec is the specification of a ReplicaSet.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiExtensionsV1beta1ReplicaSetSpec {
...
impl IoK8sApiExtensionsV1beta1ReplicaSetSpec {
  /// ReplicaSetSpec is the specification of a ReplicaSet.
  pub fn new() -> IoK8sApiExtensionsV1beta1ReplicaSetSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> IoK8sApiExtensionsV1beta1ReplicaSetSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sApiExtensionsV1beta1ReplicaSetSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiExtensionsV1beta1ReplicaSetSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiExtensionsV1beta1ReplicaSetSpec {
    self.template = Some(template);
    self
  }
