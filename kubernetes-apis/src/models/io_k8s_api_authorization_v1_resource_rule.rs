...
pub struct IoK8sApiAuthorizationV1ResourceRule {
...
impl IoK8sApiAuthorizationV1ResourceRule {
  /// ResourceRule is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
  pub fn new(verbs: Vec<String>) -> IoK8sApiAuthorizationV1ResourceRule {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> IoK8sApiAuthorizationV1ResourceRule {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_resource_names(mut self, resource_names: Vec<String>) -> IoK8sApiAuthorizationV1ResourceRule {
    self.resource_names = Some(resource_names);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> IoK8sApiAuthorizationV1ResourceRule {
    self.resources = Some(resources);
    self
  }
  ...
  pub fn with_verbs(mut self, verbs: Vec<String>) -> IoK8sApiAuthorizationV1ResourceRule {
    self.verbs = verbs;
    self
  }
