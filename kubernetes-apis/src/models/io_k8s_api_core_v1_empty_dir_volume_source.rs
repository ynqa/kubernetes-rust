...
impl IoK8sApiCoreV1EmptyDirVolumeSource {
  ...
  pub fn with_medium(mut self, medium: String) -> IoK8sApiCoreV1EmptyDirVolumeSource {
    self.medium = Some(medium);
    self
  }
  ...
  pub fn with_size_limit(mut self, size_limit: String) -> IoK8sApiCoreV1EmptyDirVolumeSource {
    self.size_limit = Some(size_limit);
    self
  }
