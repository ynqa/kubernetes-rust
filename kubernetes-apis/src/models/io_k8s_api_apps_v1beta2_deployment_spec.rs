...
/// IoK8sApiAppsV1beta2DeploymentSpec : DeploymentSpec is the specification of the desired behavior of the Deployment.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiAppsV1beta2DeploymentSpec {
  ...
  strategy: Option<::models::IoK8sApiAppsV1beta2DeploymentStrategy>,
  #[serde(rename = "template")]
  template: ::models::IoK8sApiCoreV1PodTemplateSpec
}

impl IoK8sApiAppsV1beta2DeploymentSpec {
  /// DeploymentSpec is the specification of the desired behavior of the Deployment.
  pub fn new(selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1beta2DeploymentSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_paused(mut self, paused: bool) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.paused = Some(paused);
    self
  }
  ...
  pub fn with_progress_deadline_seconds(mut self, progress_deadline_seconds: i32) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.progress_deadline_seconds = Some(progress_deadline_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.selector = selector;
    self
  }
  ...
  pub fn set_strategy(&mut self, strategy: ::models::IoK8sApiAppsV1beta2DeploymentStrategy) {
    self.strategy = Some(strategy);
  }

  pub fn with_strategy(mut self, strategy: ::models::IoK8sApiAppsV1beta2DeploymentStrategy) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.strategy = Some(strategy);
    self
  }

  pub fn strategy(&self) -> Option<&::models::IoK8sApiAppsV1beta2DeploymentStrategy> {
  ...
  pub fn with_template(mut self, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1beta2DeploymentSpec {
    self.template = template;
    self
  }
