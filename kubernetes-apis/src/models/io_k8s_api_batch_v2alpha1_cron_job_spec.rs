...
pub struct IoK8sApiBatchV2alpha1CronJobSpec {
  ...
  job_template: ::models::IoK8sApiBatchV2alpha1JobTemplateSpec,
...
impl IoK8sApiBatchV2alpha1CronJobSpec {
  /// CronJobSpec describes how the job execution will look like and when it will actually run.
  pub fn new(job_template: ::models::IoK8sApiBatchV2alpha1JobTemplateSpec, schedule: String) -> IoK8sApiBatchV2alpha1CronJobSpec {
  ...
  pub fn with_concurrency_policy(mut self, concurrency_policy: String) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.concurrency_policy = Some(concurrency_policy);
    self
  }
  ...
  pub fn with_failed_jobs_history_limit(mut self, failed_jobs_history_limit: i32) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.failed_jobs_history_limit = Some(failed_jobs_history_limit);
    self
  }
  ...
  pub fn set_job_template(&mut self, job_template: ::models::IoK8sApiBatchV2alpha1JobTemplateSpec) {
    self.job_template = job_template;
  }

  pub fn with_job_template(mut self, job_template: ::models::IoK8sApiBatchV2alpha1JobTemplateSpec) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.job_template = job_template;
    self
  }

  pub fn job_template(&self) -> &::models::IoK8sApiBatchV2alpha1JobTemplateSpec {
    &self.job_template
  }
  ...
  pub fn with_schedule(mut self, schedule: String) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.schedule = schedule;
    self
  }
  ...
  pub fn with_starting_deadline_seconds(mut self, starting_deadline_seconds: i64) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.starting_deadline_seconds = Some(starting_deadline_seconds);
    self
  }
  ...
  pub fn with_successful_jobs_history_limit(mut self, successful_jobs_history_limit: i32) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.successful_jobs_history_limit = Some(successful_jobs_history_limit);
    self
  }
  ...
  pub fn with_suspend(mut self, suspend: bool) -> IoK8sApiBatchV2alpha1CronJobSpec {
    self.suspend = Some(suspend);
    self
  }
