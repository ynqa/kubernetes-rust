...
/// IoK8sApiAppsV1beta1DeploymentSpec : DeploymentSpec is the specification of the desired behavior of the Deployment.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct IoK8sApiAppsV1beta1DeploymentSpec {
  ...
  rollback_to: Option<::models::IoK8sApiAppsV1beta1RollbackConfig>,
  #[serde(rename = "selector")]
  selector: Option<::models::IoK8sApimachineryPkgApisMetaV1LabelSelector>,
  #[serde(rename = "strategy")]
  strategy: Option<::models::IoK8sApiAppsV1beta1DeploymentStrategy>,
  #[serde(rename = "template")]
  template: ::models::IoK8sApiCoreV1PodTemplateSpec
}

impl IoK8sApiAppsV1beta1DeploymentSpec {
  /// DeploymentSpec is the specification of the desired behavior of the Deployment.
  pub fn new(template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1beta1DeploymentSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_paused(mut self, paused: bool) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.paused = Some(paused);
    self
  }
  ...
  pub fn with_progress_deadline_seconds(mut self, progress_deadline_seconds: i32) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.progress_deadline_seconds = Some(progress_deadline_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn set_rollback_to(&mut self, rollback_to: ::models::IoK8sApiAppsV1beta1RollbackConfig) {
    self.rollback_to = Some(rollback_to);
  }

  pub fn with_rollback_to(mut self, rollback_to: ::models::IoK8sApiAppsV1beta1RollbackConfig) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.rollback_to = Some(rollback_to);
    self
  }

  pub fn rollback_to(&self) -> Option<&::models::IoK8sApiAppsV1beta1RollbackConfig> {
  ...
  pub fn with_selector(mut self, selector: ::models::IoK8sApimachineryPkgApisMetaV1LabelSelector) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn set_strategy(&mut self, strategy: ::models::IoK8sApiAppsV1beta1DeploymentStrategy) {
    self.strategy = Some(strategy);
  }

  pub fn with_strategy(mut self, strategy: ::models::IoK8sApiAppsV1beta1DeploymentStrategy) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.strategy = Some(strategy);
    self
  }

  pub fn strategy(&self) -> Option<&::models::IoK8sApiAppsV1beta1DeploymentStrategy> {
  ...
  pub fn with_template(mut self, template: ::models::IoK8sApiCoreV1PodTemplateSpec) -> IoK8sApiAppsV1beta1DeploymentSpec {
    self.template = template;
    self
  }
