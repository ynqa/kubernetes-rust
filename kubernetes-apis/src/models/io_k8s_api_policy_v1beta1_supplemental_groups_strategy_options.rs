...
pub struct IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions {
...
impl IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions {
  /// SupplementalGroupsStrategyOptions defines the strategy type and options used to create the strategy.
  pub fn new() -> IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions {
  ...
  pub fn with_ranges(mut self, ranges: Vec<::models::IoK8sApiPolicyV1beta1IdRange>) -> IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions {
    self.ranges = Some(ranges);
    self
  }
  ...
  pub fn with_rule(mut self, rule: String) -> IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions {
    self.rule = Some(rule);
    self
  }
