...
pub trait AuthenticationApi {
    fn get_authentication_api_group(&self, ) -> Result<::models::IoK8sApimachineryPkgApisMetaV1ApiGroup, Error>;
}
...
impl AuthenticationApi for AuthenticationApiClient {
    fn get_authentication_api_group(&self, ) -> Result<::models::IoK8sApimachineryPkgApisMetaV1ApiGroup, Error> {
        ...
        let uri_str = format!("{}/apis/authentication.k8s.io/?{}", configuration.base_path, query_string);
