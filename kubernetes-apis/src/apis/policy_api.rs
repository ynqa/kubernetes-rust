...
pub trait PolicyApi {
    fn get_policy_api_group(&self, ) -> Result<::models::IoK8sApimachineryPkgApisMetaV1ApiGroup, Error>;
}
...
impl PolicyApi for PolicyApiClient {
    fn get_policy_api_group(&self, ) -> Result<::models::IoK8sApimachineryPkgApisMetaV1ApiGroup, Error> {
        ...
        let uri_str = format!("{}/apis/policy/?{}", configuration.base_path, query_string);
